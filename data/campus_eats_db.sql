...
INSERT INTO `driver` VALUES (1,110,'fi3980','1989-01-18',6.2),(2,98,'js4003','2017-03-15',6),(3,104,'xt8429','2002-10-11',5.93333),(4,43,'yv6392','2010-02-23',5),(5,75,'cf3679','1997-04-06',4.55556),(6,68,'rx3942','1970-03-24',3.25),(7,143,'mf2647','2014-05-06',6.53846),(8,96,'ia9372','2011-06-25',6.41667);
...
CREATE TABLE `driver_rating` (
  ...
  `rating` float DEFAULT NULL,
  KEY `fk_D_id_idx` (`id`),
  CONSTRAINT `fk_D_id` FOREIGN KEY (`id`) REFERENCES `driver` (`driver_id`)
...
INSERT INTO `driver_rating` VALUES (1,6),(2,7),(2,7),(3,10),(1,9),(4,5),(5,3),(8,10),(7,8),(4,5),(2,4),(7,9),(7,1),(1,5),(6,3),(3,10),(4,3),(8,6),(4,5),(8,7),(5,1),(3,3),(6,2),(6,4),(4,4),(8,7),(2,5),(6,1),(5,8),(1,6),(8,3),(8,5),(3,9),(8,7),(3,2),(2,9),(3,5),(4,7),(2,4),(4,7),(5,3),(6,4),(8,8),(4,5),(4,7),(3,6),(5,3),(6,1),(7,6),(7,8),(7,5),(5,6),(3,4),(6,8),(2,1),(2,8),(8,5),(1,3),(2,3),(8,8),(6,1),(6,5),(4,1),(2,6),(1,5),(4,10),(1,8),(6,2),(7,8),(4,2),(4,2),(7,7),(1,6),(3,2),(4,5),(4,7),(3,10),(1,6),(7,1),(7,10),(7,8),(7,5),(3,8),(5,3),(6,2),(8,1),(7,9),(4,5),(3,9),(2,5),(5,5),(1,8),(5,9),(3,1),(2,10),(3,1),(3,9),(8,10),(2,9),(6,6);
...
INSERT INTO `restaurant` VALUES (1,'5357 Adrianna Shoal Suite 418\nEnochside, OH 46739-1915','Rath Ltd','9am -10pm','http://hahn.com/',7),(2,'6977 Adams Locks Suite 001\nErikastad, LA 55321-5793','Kerluke-Herman','11am - 11pm','http://wilderman.com/',9),(3,'559 Robin Cape\nWest Merl, OH 31271-9957','Berge Inc','11am - 11pm','http://okunevarohan.com/',1),(4,'4501 Labadie Via\nLake America, NJ 33290','Hamill, Prohaska and Lehner','10am - 9pm','http://jacobswilderman.info/',7),(5,'5587 Fanny Port\nNorth Nigel, NC 05813','Ratke LLC','10am - 9pm','http://www.williamson.org/',10),(6,'3906 Wilkinson Street Suite 611\nLake Moisesburgh, DE 83148','Fisher-Rempel','9am -10pm','http://www.lehner.net/',8),(7,'459 Labadie Course Suite 026\nNorth Ola, ND 60631','Ryan, Jaskolski and Schinner','10am - 9pm','http://www.schuster.org/',2),(8,'630 Block Harbors\nEast Rudolphhaven, LA 44638','Kub, Borer and Ward','11am - 11pm','http://klingprohaska.com/',5),(9,'40616 Mante Islands\nSouth Gileschester, MI 75466','O\'Conner-Mraz','9am -10pm','http://www.rosenbaum.com/',5),(10,'9015 Velma Junction\nSpencerland, KY 15821-5602','Mayert LLC','9am -10pm','http://www.raynorgoldner.com/',4),(11,'48482 Bode Harbors\nPort Modesta, AZ 10082-7993','Grady, Kreiger and Frami','10am - 9pm','http://skiles.com/',10),(12,'597 Leora Summit Apt. 714\nEbertbury, WI 48130-6262','Abbott-Schmitt','9am -10pm','http://feil.com/',2),(13,'387 Tromp Estates Suite 445\nWest Leopoldshire, NC 80009','Ankunding Group','9am -10pm','http://www.balistreri.info/',9),(14,'679 Russel Villages\nConnellyfort, MD 72266','Weber, Lehner and Mueller','9am -10pm','http://mccullough.com/',7),(15,'177 Katrina Gateway Apt. 797\nJastport, MN 44988-2805','Connelly, Wolf and Murazik','10am - 9pm','http://mraz.com/',4),(16,'3136 Kunde Ports Apt. 399\nLake Trevor, CO 19002','Abernathy, Lehner and Zulauf','10am - 9pm','http://kirlinkulas.com/',8),(17,'03334 Blanda Trafficway Suite 568\nFloyfort, OK 34900-7724','Heathcote, Kovacek and Cummerata','9am -10pm','http://glover.biz/',7),(18,'031 Milton Bypass Suite 952\nStephonburgh, WY 82916-7389','Hauck, Rodriguez and Cremin','11am - 11pm','http://reynolds.com/',9),(19,'375 Alanna Crossroad Suite 259\nNorth Shanna, MN 54873','Hermiston-Purdy','11am - 11pm','http://herzog.com/',5),(20,'9359 Marcos Park Apt. 091\nSchmitttown, IL 68853','Smitham-Haley','11am - 11pm','http://quitzonmckenzie.com/',7),(21,'215 Shanon Creek\nEast Antonettaview, MN 74167-8029','Cruickshank-Reilly','10am - 9pm','http://rodriguezkshlerin.com/',8),(22,'0562 Cassin Divide\nElenorafurt, AR 37048','Eichmann-Casper','10am - 9pm','http://www.farrell.biz/',2),(23,'41925 Bosco Station Apt. 238\nSouth Clara, MA 87547-3817','Gorczany, Kuphal and Pouros','9am -10pm','http://www.dare.com/',7),(24,'9119 Cummerata Avenue Suite 529\nAbshiremouth, ND 00145-7770','Moen Ltd','9am -10pm','http://www.eichmannhomenick.org/',7),(25,'422 Lesch Common Apt. 940\nNew Felicitaborough, IL 21308-3053','Keeling, Maggio and Hirthe','10am - 9pm','http://hermannwalter.info/',8),(26,'52787 Ullrich Locks\nReynoldsside, IA 48689-5885','Mraz, Reichel and Hermiston','11am - 11pm','http://www.runolfsdottir.com/',4),(27,'1135 Bartell Islands\nLake Philipton, HI 43588-0971','Oberbrunner-Herman','10am - 9pm','http://www.rice.com/',7),(28,'8279 Concepcion Center\nHauckshire, AL 83821','Stanton-D\'Amore','9am -10pm','http://nienow.com/',8),(29,'283 Nadia Islands\nAudreanneburgh, GA 64125-4442','Waelchi LLC','11am - 11pm','http://www.littel.net/',6),(30,'093 Fredrick Spurs\nSouth Shannamouth, RI 24292','Ziemann, Denesik and Kunze','10am - 9pm','http://www.klinghilll.info/',8),(31,'3948 Kiehn Forest Apt. 782\nHageneschester, VT 94419','Tromp Ltd','9am -10pm','http://white.com/',5),(32,'4652 Maeve Brook\nSouth Corine, WA 21701-5426','Beatty Ltd','11am - 11pm','http://parisian.biz/',1),(33,'4863 Becker Spring\nNorth Candelarioburgh, UT 16649-1046','Gutmann LLC','10am - 9pm','http://beahan.net/',8),(34,'46083 Mekhi Ridge\nLake Jerrodhaven, VT 38507-5949','Macejkovic Ltd','9am -10pm','http://www.beahan.com/',8),(35,'214 Lyric Mission\nPort Meaganview, AR 17033','Rolfson LLC','9am -10pm','http://skiles.com/',5),(36,'96083 Konopelski Isle Suite 006\nBruenfort, KY 49444-9497','Marquardt, Reinger and Gusikowski','11am - 11pm','http://www.daniel.com/',1),(37,'213 Larkin Coves\nQuintonside, TX 07955','Harber Group','10am - 9pm','http://www.goodwin.biz/',5),(38,'0859 Hills Pine Apt. 888\nMyriammouth, NM 69940-8316','Wuckert, Reilly and Wuckert','9am -10pm','http://www.boscokilback.com/',8),(39,'67511 Graham Shore\nLaceyland, WI 78493','Kirlin, Gibson and Kovacek','9am -10pm','http://schinner.com/',10),(40,'0416 Nyasia Hills\nWest Penelope, MA 56613','Morissette, Kutch and Spinka','11am - 11pm','http://www.smitham.biz/',8),(41,'6044 Prohaska Oval\nWillton, MI 09742','Corkery, Kilback and Skiles','10am - 9pm','http://www.schumm.com/',9),(42,'0561 Dora Manors Suite 455\nNew Aliamouth, CO 28487-7002','Huels-Considine','11am - 11pm','http://dareboehm.biz/',8),(43,'719 Virgil Orchard Apt. 083\nSouth Amalia, KY 78515-9294','Gusikowski, Funk and Rau','10am - 9pm','http://www.johnston.org/',10),(44,'8474 Joana Rest\nNorth Kariane, MI 13273-8980','Friesen, Zemlak and Runolfsson','9am -10pm','http://www.schillerstreich.org/',8),(45,'85504 Jacky Radial Suite 460\nBeauberg, ND 20689','Hayes-O\'Hara','9am -10pm','http://www.feest.net/',4),(46,'791 Lennie Tunnel Apt. 153\nTyreekshire, DC 94328','Sporer, Reinger and Runte','10am - 9pm','http://www.gerhold.com/',7),(47,'269 Keeling Forks\nBauchfort, TN 32390-9816','Rutherford, Cummerata and Langosh','10am - 9pm','http://pacocha.net/',1),(48,'976 Gislason Heights Suite 926\nChristiansenshire, FL 00995','McGlynn PLC','10am - 9pm','http://langoshmcclure.com/',1),(49,'3227 Witting Landing\nFerrystad, WY 43540','Crooks, Corkery and Dickinson','11am - 11pm','http://hudson.com/',10),(50,'59694 Ulises Ranch Apt. 292\nRobelhaven, NY 81549','Jenkins-Greenholt','11am - 11pm','http://feil.net/',7),(51,'71811 Gertrude Via Suite 007\nSouth Taryn, NV 23967','Waters, Turner and Adams','9am -10pm','http://franeckikuhn.com/',8),(52,'09615 Green Shores Suite 103\nJaquanmouth, VA 66615','Hilpert, Von and Frami','11am - 11pm','http://gloverhansen.com/',1),(53,'7385 Douglas Rapid\nLake Eusebioberg, NV 04724','Larkin, Lakin and Huel','11am - 11pm','http://www.pfeffer.com/',9),(54,'121 Hartmann Falls Apt. 221\nEast Ashleyshire, CT 19450','Cremin Ltd','10am - 9pm','http://davis.com/',3),(55,'9775 Victoria Inlet\nWest Clifford, NV 16309-4617','Orn, Kshlerin and Ebert','10am - 9pm','http://www.wisokywilderman.net/',4),(56,'983 Macie Squares Apt. 211\nEast Lyda, PA 70725','Keeling-Jaskolski','11am - 11pm','http://doyle.com/',10),(57,'801 Strosin Village\nDouglasbury, WY 85892','Kuhn-Kuhn','10am - 9pm','http://www.blick.com/',2),(58,'162 Renner Walk\nNew Lexie, IN 72766','Runolfsdottir-Hagenes','9am -10pm','http://hickle.info/',9),(59,'207 Berge Turnpike\nNorth Bulah, NY 56382-2747','Bradtke, Johnston and Baumbach','11am - 11pm','http://jones.org/',7),(60,'93126 O\'Reilly Stream\nSouth Reneebury, NE 37534','Schulist-Dickinson','9am -10pm','http://www.huels.net/',8),(61,'7027 Harold Vista Apt. 309\nSouth Lamarchester, AK 74002','Rath, Lebsack and Hane','10am - 9pm','http://www.sawayn.com/',3),(62,'070 Valerie Radial\nLake Geraldine, ID 66048','Botsford Inc','9am -10pm','http://kesslergreenholt.com/',8),(63,'83563 Gabe Cliffs Suite 176\nMurraybury, MI 42637-0699','Klocko and Sons','9am -10pm','http://cruickshankhahn.org/',1),(64,'65258 Nelle Bypass Apt. 441\nNew Noemie, OR 56221-2401','Greenfelder-Strosin','11am - 11pm','http://www.quitzon.com/',9),(65,'392 Terry Common\nReneeburgh, GA 16078-5698','Volkman Group','10am - 9pm','http://hansen.com/',9),(66,'58362 Weimann View Apt. 783\nBorertown, IA 93172','Stanton-Marvin','10am - 9pm','http://johns.org/',8),(67,'7339 Ziemann Common\nWest Diamondport, NC 14355-1563','Huels, Schamberger and Volkman','9am -10pm','http://www.greenholtlittle.com/',6),(68,'172 Daisy Overpass\nFeestbury, MI 69119','Bahringer, Herman and Lebsack','10am - 9pm','http://www.reichert.info/',6),(69,'744 Trudie Row Apt. 555\nLake Eduardoport, AL 24252-6634','Von and Sons','9am -10pm','http://www.buckridge.com/',6),(70,'0420 Waelchi Ferry\nCedrickberg, KY 95033-5914','Daniel PLC','11am - 11pm','http://www.barton.com/',9),(71,'90000 Pinkie Summit\nSouth Ansleyport, NJ 05455','Daniel, Ledner and Keebler','9am -10pm','http://swift.com/',1),(72,'267 Kemmer Dam Suite 757\nLake Shanna, ND 06978-8017','Shields-Wehner','9am -10pm','http://maggiowisozk.com/',10),(73,'5242 Maymie Prairie\nJosephinechester, CT 08166','Davis-Gottlieb','10am - 9pm','http://kiehn.com/',1),(74,'503 Halvorson Roads\nEmilianomouth, WY 48846','Kuhic, DuBuque and Rutherford','10am - 9pm','http://mcdermott.com/',4),(75,'61619 White Lock\nKassulkeberg, SD 92407','Miller-Schuppe','9am -10pm','http://langworth.net/',7),(76,'2686 Rosina Drives\nLake Irving, WI 93674','Marquardt and Sons','9am -10pm','http://schoen.info/',9),(77,'665 Reba Field Suite 259\nAbbieville, HI 45209','Heller-Stoltenberg','10am - 9pm','http://keebler.net/',5),(78,'274 Aniyah View\nCorkerybury, NJ 42353-0485','Kub-Bartoletti','10am - 9pm','http://www.walkerschuster.biz/',4),(79,'136 Champlin Circles Suite 260\nElmiraburgh, NY 86723','Pollich-Connelly','10am - 9pm','http://quigleyjohns.com/',1),(80,'6656 Durgan Glens\nSidneyfort, NY 23527-3946','Predovic Group','11am - 11pm','http://www.mcclure.info/',8),(81,'916 Kenna Walks Apt. 224\nDomenichaven, SD 08585','Thiel-Paucek','11am - 11pm','http://www.klein.com/',8),(82,'87162 Keven Wall\nNew Amya, GA 23801-4982','Bednar and Sons','10am - 9pm','http://hamill.org/',10),(83,'32020 Langworth Way\nJaycefort, MT 55909','Sipes-Carroll','9am -10pm','http://larkin.net/',1),(84,'198 Mazie Bypass Apt. 852\nPort Newellland, ID 46813-6856','Kohler-Predovic','10am - 9pm','http://hermiston.com/',3),(85,'8170 Orn Pine\nJadonton, MN 06564-1919','Fisher, Yundt and Wiegand','10am - 9pm','http://friesen.com/',5),(86,'6809 Kulas Circles Suite 622\nPort Leonieland, KS 31358-9888','Corwin Inc','10am - 9pm','http://turner.com/',3),(87,'540 Maximillia Via Suite 247\nNew Christine, OH 16149-9776','Veum PLC','10am - 9pm','http://www.shields.biz/',4),(88,'8085 Alvina Isle Apt. 893\nJamisonland, MD 06507','Barrows Group','10am - 9pm','http://www.marquardtschumm.com/',3),(89,'7446 Jarrett Plaza\nNew Phoebeview, ME 25224','Kub, Hoeger and Swaniawski','10am - 9pm','http://www.haley.biz/',10),(90,'631 Wilkinson Shoal Apt. 785\nMadisynbury, NE 51948','Kerluke-Flatley','11am - 11pm','http://www.waters.net/',4),(91,'86467 Kshlerin Point\nHeathcotetown, AZ 27728-4616','Rowe, Pouros and Gutkowski','11am - 11pm','http://gerlach.com/',9),(92,'92578 Kylie Trafficway Suite 755\nLake Murphy, GA 78904','Grimes-Sporer','9am -10pm','http://www.osinski.com/',9),(93,'72392 Hahn Station Apt. 674\nWest Josianeside, MT 59330-3244','Price-Reinger','11am - 11pm','http://stoltenbergmohr.biz/',1),(94,'9329 Vesta Harbors Suite 849\nUllrichchester, DC 53814','Boehm, White and Kilback','9am -10pm','http://www.hillljohnson.com/',1),(95,'30248 Eichmann Street Suite 151\nLake Nelson, VT 78923-5543','Conroy-O\'Keefe','10am - 9pm','http://hermiston.org/',1),(96,'1070 Green Forks\nSelenaland, VT 70941','Wiegand LLC','9am -10pm','http://www.streich.com/',4),(97,'20073 Clyde Ways Suite 898\nWest Dejahchester, GA 59632','Donnelly and Sons','10am - 9pm','http://cummings.net/',3),(98,'215 Altenwerth Mall Apt. 621\nDietrichberg, MI 96944','McDermott, Senger and Ferry','10am - 9pm','http://www.collins.net/',1),(99,'1105 Liza Shores Apt. 158\nHermannland, GA 62111','Grimes-Lakin','9am -10pm','http://terry.net/',5),(100,'88626 Louvenia Fork\nLake Maxiefurt, TN 43522','Mertz Ltd','9am -10pm','http://ortiz.com/',3);
...
CREATE TABLE `restaurant_rating` (
  ...
  `rating` float DEFAULT NULL,
  KEY `fk_R_id_idx` (`id`),
  CONSTRAINT `fk_R_id` FOREIGN KEY (`id`) REFERENCES `restaurant` (`restaurant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `restaurant_rating` VALUES (1,7),(2,9),(3,1),(4,7),(5,10),(6,8),(7,2),(8,5),(9,5),(10,4),(11,10),(12,2),(13,9),(14,7),(15,4),(16,8),(17,7),(18,9),(19,5),(20,7),(21,8),(22,2),(23,7),(24,7),(25,8),(26,4),(27,7),(28,8),(29,6),(30,8),(31,5),(32,1),(33,8),(34,8),(35,5),(36,1),(37,5),(38,8),(39,10),(40,8),(41,9),(42,8),(43,10),(44,8),(45,4),(46,7),(47,1),(48,1),(49,10),(50,7),(51,8),(52,1),(53,9),(54,3),(55,4),(56,10),(57,2),(58,9),(59,7),(60,8),(61,3),(62,8),(63,1),(64,9),(65,9),(66,8),(67,6),(68,6),(69,6),(70,9),(71,1),(72,10),(73,1),(74,4),(75,7),(76,9),(77,5),(78,4),(79,1),(80,8),(81,8),(82,10),(83,1),(84,3),(85,5),(86,3),(87,4),(88,3),(89,10),(90,4),(91,9),(92,9),(93,1),(94,1),(95,1),(96,4),(97,3),(98,1),(99,5),(100,3);
...
-- Dump completed on 2020-12-06 18:01:38
